...
registerOnClick('shpere black', false, false, [0,1,2], function() {
  assignMat('metal stand', 'black');
}, function() {});

registerOnClick('shpere chrome', false, false, [0,1,2], function() {
  assignMat('metal stand', 'chrome');
}, function() {});

registerOnClick('shpere white', false, false, [0,1,2], function() {
  assignMat('metal stand', 'white');
}, function() {});

registerOnClick('slab1', false, false, [0,1,2], function() {
  replaceTexture('wm 1s', 'wooooD', 'wood_basecolor_1.jpg', function() {});
}, function() {});

registerOnClick('slab2', false, false, [0,1,2], function() {
  replaceTexture('wm 1s', 'wooooD', 'wood_basecolor_2.jpg', function() {});
}, function() {});

registerOnClick('slab3', false, false, [0,1,2], function() {
  replaceTexture('wm 1s', 'wooooD', 'wood_basecolor_3.jpg', function() {});
}, function() {});
